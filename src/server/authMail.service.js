...
exports.sendConfirmationEmail = async function (name, email, confirmationCode){
  transport.sendMail({
    ...
    html: `<h1>Email Confirmation</h1>
        ...
        <a href=${process.env.FRONTEND_CONFIRMATIONEMAIL_PATHBASE}${confirmationCode}> Click here</a>
        </div>`,
...
exports.sendForgotPasswordEmail = async function (email, confirmationCode){
  ...
  transport.sendMail({
    ...
    html: `<p>You requested for reset password, use this link
     <a href=${process.env.FRONTEND_FORGOTPASSWORD_PATHBASE}${confirmationCode}> Click here </a> 
